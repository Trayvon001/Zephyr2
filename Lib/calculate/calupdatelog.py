...
# Form implementation generated from reading ui file 'calupdatelog.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(433, 540)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setStyleSheet("border:2px groove gray;border-radius:10px;padding:2px 4px;")
        ...
        self.updatelogdisplay.setStyleSheet("background-color: rgb(255, 250, 242);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "计算模式更新日志"))
